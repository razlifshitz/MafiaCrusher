...
#ifndef MAFIA_TRAINER_SWIFT_H
#define MAFIA_TRAINER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="mafia_trainer",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC13mafia_trainer11AppDelegate")
...
SWIFT_CLASS("_TtC13mafia_trainer17MainFlutterWindow")
